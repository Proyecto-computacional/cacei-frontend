    ...
    const mapApiDataToFormFields = (sectionId, apiData) => {
        const mappers = {
            ...
            2: (data) => ({
                ...
                horas: data.hours,
                teacher_training_id: data.teacher_training_id
            }),
            3: (data) => ({
                ...
                horas: data.hours,
                disciplinary_update_id: data.disciplinary_update_id
            }),
            4: (data) => ({
                ...
                academic_management_id: data.academic_management_id
            }),
            5: (data) => ({
                descripcion: data.description,
                academic_product_id: data.academic_product_id
            }),
            6: (data) => ({
                ...
                fechaInicio: data.start_date,
                fechaFin: data.end_date,
                laboral_experience_id: data.laboral_experience_id
            }),
            7: (data) => ({
                organismo: data.institution,
                periodo: data.period,
                nivel: data.level_experience,
                engineering_design_id: data.engineering_design_id
            }),
            8: (data) => ({
                descripcion: data.description,
                professional_achievement_id: data.professional_achievement_id
            }),
            9: (data) => ({
                organismo: data.institution,
                periodo: data.period,
            ...
            const sectionConfigs = {
                1: {
                    endpoint: 'educations', transform: (row) => ({
                        education_id: row.values.education_id,
                ...
                2: {
                    endpoint: 'teacher-trainings', transform: (row) => ({
                        teacher_training_id: row.values.teacher_training_id,
                ...
                3: {
                    endpoint: 'disciplinary-updates', transform: (row) => ({
                        disciplinary_update_id: row.values.disciplinary_update_id,
                ...
                4: {
                    endpoint: 'academic-managements', transform: (row) => ({
                        academic_management_id: row.values.academic_management_id,
                ...
                5: {
                    endpoint: 'academic-products', transform: (row) => ({
                        academic_product_id: row.values.academic_product_id,
                        description: row.values.descripcion
                    })
                },
                6: {
                    endpoint: 'laboral-experiences', transform: (row) => ({
                        laboral_experience_id: row.values.laboral_experience_id,
                ...
                7: {
                    endpoint: 'engineering-designs', transform: (row) => ({
                        engineering_design_id: row.values.engineering_design_id,
                ...
                8: {
                    endpoint: 'professional-achievements', transform: (row) => ({
                        professional_achievement_id: row.values.professional_achievement_id,
                        description: row.values.descripcion
                    })
                },
                9: {
                    endpoint: 'participations', transform: (row) => ({
                        participation_id: row.values.participation_id,
                        institution: row.values.organismo,
                        period: row.values.periodo,
                ...
                10: {
                    endpoint: 'awards', transform: (row) => ({
                        award_id: row.values.award_id,
                        description: row.values.descripcion
                    })
                },
                11: {
                    endpoint: 'contributions-to-pe', transform: (row) => ({
                        contribution_id: row.values.contribution_id,
                        description: row.values.descripcion
                    })
                }
            };
