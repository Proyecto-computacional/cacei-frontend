    ...
    const sections = [
        ...
        },
        {
            ...
            campos: [
                ...
                { name: "periodo", type: "number", label: "Período (años)", placeholder: "Años", min: 0, max: 99, maxLength: 2 },
        ...
        },
        {
            ...
            campos: [
                ...
                { name: "organismo", type: "text", label: "Organismo", placeholder: "Nombre del organismo", maxLength: 30 },
                { name: "periodo", type: "number", label: "Periodo (años)", placeholder: "Años", min: 0, max: 99, maxLength: 2 },
                { name: "nivel", type: "text", label: "Nivel de participación", placeholder: "Miembro, socio, directivo, etc.", maxLength: 20 },
            ],
        },
        {
            id: 10,
